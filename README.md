...
├── tests/                562 pytest cases incl. performance budgets
...
| **pytest + httpx** | Automated test suite (562 tests, incl. performance budgets) |
...
- **Remaining scope** (headline items — the backlog holds the detail):
  ...
  - **Continuous integration** — ✅ landed at Sprint 2 close: [`ci.yml`](.github/workflows/ci.yml) runs ruff + the full suite (562 tests) on every push and PR; Sprint 3 grows it with browser E2E and a post-deploy smoke.
