...
├── tests/                1184 pytest cases incl. performance budgets
...
| **pytest + httpx** | Automated test suite (1184 tests, incl. performance budgets) — **96% line coverage** over `app/` + `main.py` (`make coverage`) |
