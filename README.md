...
├── tests/                1270 pytest cases incl. performance budgets and the
...
| **pytest + httpx** | Automated test suite (1270 tests, incl. performance budgets and the endpoint contract suites below) — **96% line coverage** over `app/` + `main.py` (`make coverage`) |
